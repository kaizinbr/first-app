...
export default function Password({
    ...
    const [step, setStep] = useState(hasPassword ? 0 : 3);
    ...
    return (
        <View style={[styles.container, { paddingTop: FIXED_BAR_HEIGHT }]}>
            ...
            <View style={[styles.section, { padding: 16 }]}>
                ...
                >
                    <Unread size={20} color={isLengthOk ? "#4caf50" : "#eee"} />
                    <TextDefault
                        style={[
                            styles.textDefault,
                            { fontSize: 14 },
                ...
                >
                    <Unread size={20} color={isCharOk ? "#4caf50" : "#eee"} />
                    <TextDefault
                        style={[
                            styles.textDefault,
                            { fontSize: 14 },
                ...
                >
                    <Unread size={20} color={isEqual ? "#4caf50" : "#eee"} />
                    <TextDefault
                        style={[
                            styles.textDefault,
                            { fontSize: 14 },
