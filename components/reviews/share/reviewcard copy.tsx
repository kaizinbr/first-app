        ...
        <View style={{ width, height, backgroundColor: "#000" }}>
            ...
            <View
                style={[
                    styles.blob,
                    {
                        backgroundColor: saturateColor(colorOne, 0.4),
                        width: "80%",
                        aspectRatio: 1,
                        top: -40,
                        left: -20,
            ...
            <View
                style={[
                    styles.blob,
                    {
                        backgroundColor: saturateColor(colorOne, .6),
                        width: "50%",
                        aspectRatio: 1,
                        top: -40,
                        right: -20,
            ...
            <View
                style={[
                    styles.blob,
                    {
                        backgroundColor: saturateColor(colorOne, 1),
                        width: "40%",
                        aspectRatio: 1,
                        top: 50,
                        right: 25,
            ...
            <View
                style={[
                    styles.blob,
                    {
                        backgroundColor: saturateColor(colorOne, 1.4),
                        width: "30%",
                        aspectRatio: 1,
                        top: 150,
                        left: 35,
            ...
            <View
                style={[
                    styles.blob,
                    {
                        backgroundColor: lightenColor(colorOne, 0.6),
                        width: "30%",
                        aspectRatio: 1,
                        top: 150,
                        right: 35,
